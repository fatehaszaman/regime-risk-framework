...
In markets operating under currency controls or import restrictions, businesses face risks that standard VaR and scenario tools miss entirely:
...
- **USD capacity becomes rationed** — businesses can't open all the LCs they need and must prioritize
...
Applies parameterized shocks to a position book and returns P&L attribution by shock type. Pre-built scenarios cover the most common EM regime events:
